...
for iter in pbar:
    ...
    loss = model.train_step(optimizer, input, y)
    ...
    # Print the progress
    pbar.set_description(f"Loss {loss:.2f}   VLoss {test_loss:.2f}")
...
# Make some preliminary plots, save them in the same directory as the model
